...
wget "https://raw.githubusercontent.com/hajimxmiku/mikuInstaller/master/status"
chmod +x status
cdwget "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/Autokick-debian.sh"
