...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup by Syahz86</pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf
service php5-fpm restart
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/openvpn.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/1194-debian.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/1194-client.conf"
...
# bannerssh
wget "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/bannerssh"
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/squid.conf"
...
# User Status
cd
wget "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/status"
chmod +x status
...
cd
wget "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/Autokick-debian.sh"
bash Autokick-debian.sh

# Install Monitor Multilogin Dropbear & OpenSSH
cd
wget -O /usr/bin/dropmon "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/dropmon.sh"
#cd
cd
...
cd
wget "https://raw.githubusercontent.com/hajimxmiku/mikucript/master/menu"
